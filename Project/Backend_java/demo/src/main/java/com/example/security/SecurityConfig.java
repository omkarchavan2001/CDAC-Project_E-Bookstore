...
public class SecurityConfig {
	...
	public SecurityFilterChain authorizeRequests(HttpSecurity http) throws Exception
	{
		...
		and().
		authorizeRequests()
		.requestMatchers("/user/testLogin","/user/testRegister","/user/testUpload","/user/testDownload/","/products/view","/users/signup","/users/signin",
				"/v*/api-doc*/**","/swagger-ui/**","*.png","/**").permitAll()
